...
const ProductCart = ({ product, carts, setCarts }) => {
    ...
    return (
        ...
        <div
            ...
            className="bg-white rounded-2xl shadow-lg p-6 w-[320px] relative flex flex-col"
        >
            <span className="absolute top-4 right-4 bg-blue-100 text-blue-600 text-xs px-3 py-1 rounded-full font-medium">
                {product.tag}
            </span>

            <div className="w-12 h-12 bg-red-100 flex items-center justify-center rounded-full mb-4 text-2xl">
                jjjjjjj
            </div>
            ...
            <button onClick={handleBuyBtn} className="w-full py-3 rounded-full text-white font-medium 
                             bg-gradient-to-r from-purple-400 to-purple-600 hover:opacity-90 transition">
